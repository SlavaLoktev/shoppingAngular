...
@Component({
  selector: 'app-edit-product-dialog-man',
  templateUrl: './edit-product-dialog-man.component.html',
  styleUrls: ['./edit-product-dialog-man.component.css']
})
export class EditProductDialogManComponent implements OnInit {

  constructor(
      private dialogRef: MatDialogRef<EditProductDialogManComponent>, // // для возможности работы с текущим диалог. окном
